#!/usr/bin/env ruby
# Fixed intricate drum generator using proper SoX sequencing
...
def generate_techno(tempo, bars)
  ...
  # Cleanup
  File.delete(*kick_seq, *hat_seq, "_kicks.wav", "_hats.wav", kick, hat)
...
def generate_hiphop(tempo, swing_pct, bars)
  ...
  # Cleanup
  File.delete(*kick_seq, *snare_seq, *hat_seq, "_kicks.wav", "_snares.wav", "_hats.wav", kick, snare, hat)
...
if __FILE__ == $0
  ...
  puts "🥁 FIXED INTRICATE DRUM GENERATOR"
